...
class Cliente(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Trigger al guardar
        h = ClienteHistorial(nombre=self.nombre,apellido=self.apellido,direccion=self.direccion,fecha_nacimiento=self.fecha_nacimiento,telefono=self.telefono,correo=self.correo,user=self.user,accion='1')
        h.save()
        return super(Cliente, self).save(*args, **kwargs)  # Save original

    def delete(self, *args, **kwargs):
        h = ClienteHistorial(nombre=self.nombre,apellido=self.apellido,direccion=self.direccion,fecha_nacimiento=self.fecha_nacimiento,telefono=self.telefono,correo=self.correo,user=self.user,accion='2')
        h.save()
...
class Transaccion(models.Model):
    ...
    destino = models.ForeignKey(Cuenta, related_name='destino retirable+', on_delete=models.CASCADE, null=True,
                                blank=True)
